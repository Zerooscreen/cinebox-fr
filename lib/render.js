...
const DEFAULT_TITLE = 'CineBox · Films et Séries Tendance : Synopsis, Note, Distribution et Bande-annonce Complète';
const DEFAULT_DESC = 'Sur CineBox, retrouvez le synopsis, la distribution, la note et la bande-annonce officielle des films et séries les plus populaires du moment, avec le détail des saisons et épisodes.';
const DEFAULT_OG_IMAGE = 'https://placehold.co/1200x630/17171b/8d8a92?text=CineBox';

// TODO: insérez le code de vérification Google Search Console de CE domaine
// (le code de cinebox-kr ne peut PAS être réutilisé ici -- il est lié à un autre domaine).
...
// ---------- Adsterra & Histats ----------
// PENTING: key/zone di bawah ini SAMA dengan cinebox-kr/th/de/br -> statistik akan tercampur.
// Kalau mau terpisah per-domain, buat zone baru di dashboard Adsterra & Histats khusus domain ini.
...
// Popunder SENGAJA TIDAK diaktifkan (risiko "intrusive interstitial" & UX buruk).
